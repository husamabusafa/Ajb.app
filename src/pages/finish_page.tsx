              ...
              >
                ...
                {currentItems.answer1 ? (
                  <AnswerBox>
                    ...
                    {currentItems.answer1}
                    <Header>
                      {currentItems.trueAnswer === 1 ? (
                        <MiniImg src="/correct.svg" />
                      ) : (
                        <MiniImg src="/wrong.svg" />
                      )}
                      {Math.pow(Anum, 1 / 11) - 5 == 1 ? (
                        <MiniImg src="/YoureA.svg" />
                      ) : (
                        <MiniImg src="" />
                      )}
                    </Header>
                ...
                {currentItems.answer2 ? (
                  <AnswerBox>
                    ...
                    {currentItems.answer2}
                    <Header>
                      {currentItems.trueAnswer === 2 ? (
                        <MiniImg src="/correct.svg" />
                      ) : (
                        <MiniImg src="/wrong.svg" />
                      )}
                      {Math.pow(Anum, 1 / 11) - 5 == 2 ? (
                        <MiniImg src="/YoureA.svg" />
                      ) : (
                        <MiniImg src="" />
                      )}
                ...
                {currentItems.answer3 ? (
                  <AnswerBox>
                    ...
                    {currentItems.answer3}
                    <Header>
                      {currentItems.trueAnswer === 3 ? (
                        <MiniImg src="/correct.svg" />
                      ) : (
                        <MiniImg src="/wrong.svg" />
                      )}
                      {Math.pow(Anum, 1 / 11) - 5 == 3 ? (
                        <MiniImg src="/YoureA.svg" />
                      ) : (
                        <MiniImg src="" />
                      )}{" "}
                ...
                {currentItems.answer4 ? (
                  <AnswerBox>
                    ...
                    {currentItems.answer4}
                    <Header>
                      {currentItems.trueAnswer === 4 ? (
                        <MiniImg src="/correct.svg" />
                      ) : (
                        <MiniImg src="/wrong.svg" />
                      )}
                      {Math.pow(Anum, 1 / 11) - 5 == 4 ? (
                        <MiniImg src="/YoureA.svg" />
                      ) : (
                        <MiniImg src="" />
                      )}{" "}
                ...
                {currentItems.answer5 ? (
                  <AnswerBox>
                    ...
                    {currentItems.answer5}
                    <Header>
                      {currentItems.trueAnswer === 5 ? (
                        <MiniImg src="/correct.svg" />
                      ) : (
                        <MiniImg src="/wrong.svg" />
                      )}
                      {Math.pow(Anum, 1 / 11) - 5 == 5 ? (
                        <MiniImg src="/YoureA.svg" />
                      ) : (
                        <MiniImg src="" />
                      )}{" "}
                ...
                {currentItems.answer6 ? (
                  <AnswerBox>
                    ...
                    {currentItems.answer6}
                    <Header>
                      {currentItems.trueAnswer === 6 ? (
                        <MiniImg src="/correct.svg" />
                      ) : (
                        <MiniImg src="/wrong.svg" />
                      )}
                      {Math.pow(Anum, 1 / 11) - 5 == 6 ? (
                        <MiniImg src="/YoureA.svg" />
                      ) : (
                        <MiniImg src="" />
                      )}{" "}
                ...
                {Math.pow(Anum, 1 / 11) - 5 == currentItems.trueAnswer?<div>
                  <div style={{ color: "#009e00" }}>اجابتك صحيحة</div>
                  <div
                    style={{
                      width: "100%",
                      height: "4px",
                  ...
                  <div style={{ color: "red" }}>اجابتك خاطئة</div>
                  <div
                    style={{
                      width: "100%",
                      height: "4px",
