...
import YoureQ from './pages/youre_q'
    ...
    <MantineProvider theme={{ colorScheme: 'dark', fontFamily: 'Marhey',}} withGlobalStyles withNormalizeCSS>
     <BrowserRouter>
          <Routes>
            ...
            <Route path="/question_view/:id" element={<QuestionView />}></Route>
            <Route path="/question_view/finish/:id/:Anum" element={<FinishPage />}></Route>
